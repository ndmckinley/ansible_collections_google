...
def resource_to_request(module):
    request = { u'kind': 'compute#networkEndpointGroup',u'name': module.params.get('name'),u'description': module.params.get('description'),u'networkEndpointType': module.params.get('network_endpoint_type'),u'network': replace_resource_dict(module.params.get(u'network', {}), 'selfLink'),u'subnetwork': replace_resource_dict(module.params.get(u'subnetwork', {}), 'selfLink'),u'defaultPort': module.params.get('default_port') }
    return_vals = {}
...
def response_to_hash(module, response):
    return { u'id': response.get(u'id'),u'name': response.get(u'name'),u'description': response.get(u'description'),u'networkEndpointType': response.get(u'networkEndpointType'),u'size': response.get(u'size'),u'network': response.get(u'network'),u'subnetwork': response.get(u'subnetwork'),u'defaultPort': response.get(u'defaultPort') }
