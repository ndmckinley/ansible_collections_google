...
options:
  ...
  load_balancing_scheme:
    ...
    - Indicates whether the backend service will be used with internal or external
      ...
      be used with the other. Must be `INTERNAL` or `INTERNAL_MANAGED` for a regional
      backend service. Defaults to `INTERNAL`.
  ...
  port_name:
    ...
    - Name of backend port. The same name should appear in the instance groups referenced
      by this service. Required when the load balancing scheme is EXTERNAL. Must be
      omitted otherwise.
    required: false
    type: str
  protocol:
...
loadBalancingScheme:
  ...
  - Indicates whether the backend service will be used with internal or external load
    ...
    used with the other. Must be `INTERNAL` or `INTERNAL_MANAGED` for a regional backend
    service. Defaults to `INTERNAL`.
  returned: success
  type: str
name:
  description:
