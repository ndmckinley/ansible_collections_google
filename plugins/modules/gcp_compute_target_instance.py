...
def main():
    ...
    module = GcpModule(
        argument_spec=dict(state=dict(default='present', choices=['present', 'absent'], type='str'), name=dict(required=True, type='str'), description=dict(type='str'), instance=dict(required=True, type='dict'), nat_policy=dict(default='NO_NAT', type='str'), zone=dict(required=True, type='str')))
...
def resource_to_request(module):
    request = { u'kind': 'compute#targetInstance',u'zone': module.params.get('zone'),u'name': module.params.get('name'),u'description': module.params.get('description'),u'instance': replace_resource_dict(module.params.get(u'instance', {}), 'selfLink'),u'natPolicy': module.params.get('nat_policy') }
    return_vals = {}
...
def response_to_hash(module, response):
    return { u'name': response.get(u'name'),u'creationTimestamp': response.get(u'creationTimestamp'),u'description': response.get(u'description'),u'instance': replace_resource_dict(module.params.get(u'instance', {}), 'selfLink'),u'natPolicy': module.params.get('nat_policy') }
