...
def main():
    ...
    module = GcpModule(
        argument_spec=dict(state=dict(default='present', choices=['present', 'absent'], type='str'), value=dict(type='str'), text=dict(type='str'), name=dict(required=True, type='str'), config=dict(required=True, type='str')))
...
def resource_to_request(module):
    request = { u'name': name_pattern(module.params.get('name'), module),u'config': module.params.get('config'),u'value': module.params.get('value'),u'text': module.params.get('text') }
